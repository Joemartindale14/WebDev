...
const Facilities = () => {
  return (
    <section className="facilities">
        ...
        <hr />
        <ImageTextPair imageSrc="/entrance_img.webp" text="FRONT-OF-HOUSE
        ...
        <ImageTextPair imageSrc="/gymfloor_img.webp" text="GYM FLOOR
        ...
        <ImageTextPair imageSrc="/studio_img.webp" text="STUDIO FLOOR
        ...
        <ImageTextPair imageSrc="/changingrooms_img.webp" text="CHANGING FACILITIES
